...
// Generated by EnterpriseObjects palette at Thursday, January 29, 2004 12:24:58 PM America/New_York
...
public class _MainMenu_EOArchive_English extends com.webobjects.eoapplication.EOArchive {
    AnaglyphApplicationDelegate _anaglyphApplicationDelegate0;
    ...
    protected void _construct() {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "delegate")) != null)) {
            _anaglyphApplicationDelegate0 = (replacement == EOArchive._ObjectInstantiationDelegate.NullObject) ? null : (AnaglyphApplicationDelegate)replacement;
            _replacedObjects.setObjectForKey(replacement, "_anaglyphApplicationDelegate0");
        } else {
            _anaglyphApplicationDelegate0 = (AnaglyphApplicationDelegate)_registered(new AnaglyphApplicationDelegate(), "AnaglyphApplicationDelegate");
        }
    }
    ...
    protected void _awaken() {
        ...
        if (_replacedObjects.objectForKey("_anaglyphApplicationDelegate0") == null) {
            _connect(_owner(), _anaglyphApplicationDelegate0, "delegate");
        }
